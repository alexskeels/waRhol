...
#' @examples
#' viz_palette(warhol_palettes$namatjira_qual)
#' viz_palette(warhol_palettes$namatjira_qual, "namatjira_qual")
#' viz_palette(warhol_palettes$namatjira_qual, "namatjira_qual first 4", num = 4)
#' viz_palette(warhol_palettes$namatjira_qual, "namatjira_qual interpolated to 25", num = 25)
#'
#' @export
